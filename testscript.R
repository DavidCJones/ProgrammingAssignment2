## testscript.R
##   This is an excellent test script for Programming assignment # 2
##   Without seeing the tests I do not think I would have understood 
##   the programming assignment.  The test script was provided by a 
##   student Scott Francis in the R Programing Forum.
